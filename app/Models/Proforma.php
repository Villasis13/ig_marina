...
//                ->join('users as u','u.id_users','=','p.id_users')
//                ->where('p.profo_estado','=',1)
//                ->whereBetween('p.profo_fecha_emision',[$desde,$hasta])->orderBy('p.id_profo','desc')->get();
//            foreach ($result as $r){
//                $datos = DB::table('proformas_detalles')->where('id_profo','=',$r->id_profo)->get();
//                $total_proformas = 0;
//                foreach ($datos as $d){
//                    $total_proformas+= $d->profo_deta_cantidad  * $d->profo_deta_precio;
//                }
//                $r->total =  $total_proformas;
//            }
        }catch(\Exception $e){
